...
public:
	...
	public :
		...
		CProperty (CString cName, COLORREF clColor)
		{
			m_isColor = true;
			m_clColor = clColor;
			Create (cName, ptGroup);
...
private:
	...
	COLORREF   m_clPropertyHPTColor;
	COLORREF   m_clPropertyHPColor;
	COLORREF   m_clPropertyCPColor;
	COLORREF   m_clPropertyCVPColor;
...
public:
	...
	void		 SetPropertyHPTColor(COLORREF clPropertyHPTColor);
	void		 SetPropertyHPColor(COLORREF clPropertyHPColor);
	void		 SetPropertyCPColor(COLORREF clPropertyCPColor);
	void		 SetPropertyCVPColor(COLORREF clPropertyCVPColor);
