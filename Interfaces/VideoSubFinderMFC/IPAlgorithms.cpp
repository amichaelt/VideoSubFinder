...
int GetTransformedImage(int *ImRGB, int *ImFF, int *ImSF, int *ImTF, int *ImVE, int *ImNE, int *ImHE, int W, int H)
{
	...
	//g_pMF->m_pImageBox->ViewImage(g_ImRES1, W, H);
	//return;
...
int FindTextLines(int *ImRGB, int *ImF, int *ImNF, vector<CString> &SavedFiles, int W, int H)
{
	...
	if (g_show_results == 1) g_pMF->SaveImage(ImF, "\\TestImages\\Image0_F.jpeg", W, H);
	if (g_show_results == 1) g_pMF->SaveImage(ImNF, "\\TestImages\\Image0_NF.jpeg", W, H);
	...
	//g_pMF->m_pImageBox->ViewImage(ImNF, W, H);
	//return;
	...
	for (k=0; k<N; k++)
	{
		...
		if (g_show_results == 1) g_pMF->SaveRGBImage(g_Im, "\\TestImages\\Image1_RGB.jpeg", w*4, h*4);
		...
		if (g_show_results == 1) g_pMF->SaveImage(g_ImSF, "\\TestImages\\Image2_SF.jpeg", w*4, h*4);
		//g_pMF->m_pImageBox->ViewImage(ImSF, w*4, h*4);
		//break;

		GetFirstFilteredImage(g_ImRES1, g_ImSF, g_ImFF, w, h, (LL[k]-XB)*4, (LR[k]-XB)*4, (LLB[k]-YB)*4, (LLE[k]-YB)*4);
		if (g_show_results == 1) g_pMF->SaveImage(g_ImFF, "\\TestImages\\Image3_FF.jpeg", w*4, h*4);
		//g_pMF->m_pImageBox->ViewImage(ImFF, w*4, h*4);
		//break;
		...
		if (g_show_results == 1) g_pMF->SaveImage(g_ImRES1, "\\TestImages\\Image4_IF.jpeg", w, h);
		//g_pMF->m_pImageBox->ViewImage(g_ImRES1, w, h);
		//break;
		...
		if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES2, "\\TestImages\\Image5_SE1.jpeg", w, h);
		//g_pMF->m_pImageBox->ViewRGBImage(g_ImRES2, w, h);
		//break;
		...
		if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES2, "\\TestImages\\Image6_SE2.jpeg", w, h);
		//g_pMF->m_pImageBox->ViewRGBImage(g_ImRES2, w, h);
		//break;
		...
		if (g_show_results == 1) g_pMF->SaveImage(g_ImRES3, "\\TestImages\\Image7_IF.jpeg", w, h);
		//g_pMF->m_pImageBox->ViewImage(g_ImRES3, w, h);
		//break;
		...
		if (g_show_results == 1) g_pMF->SaveImage(g_ImRES3, "\\TestImages\\Image7_IFB.jpeg", w, h);
		...
		while(1)
		{
			...
			if ( (val_prev != -1) && ( ( (val < val_prev) && (d_cnt_prev*d_cnt >= 0) ) || ( (d_cnt_prev*d_cnt <= 0) && (delta_new > 80) ) ) ) 
			{
				...
				if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES1, "\\TestImages\\Image8_RGF.jpeg", w, h);
			}
			...
			if ( (d_cnt > 0) && (recn == 2) )
			{
				...
				for(delta = 60; delta <= 120; delta += 20)
				{
					...
					while(1)
					{
						...
						if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES1, "\\TestImages\\Image8_RGFC.jpeg", w, h);
			...
			else if ( (d_cnt > 0) && (recn < 2) )
			{
				...
				if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES1, "\\TestImages\\Image8_RGFB.jpeg", w, h);
		...
		if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES1, "\\TestImages\\Image8_RGFF.jpeg", w, h);
		...
		if (g_hard_sub_mining == true) while(1)
		{
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES1, "\\TestImages\\Image8_SE1_01.jpeg", w, h);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES2, "\\TestImages\\Image8_SE1_02.jpeg", w, h);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES3, "\\TestImages\\Image8_SE1_03.jpeg", w, h);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES4, "\\TestImages\\Image8_SE1_04.jpeg", w, h);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES5, "\\TestImages\\Image8_SE1_05.jpeg", w, h);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES6, "\\TestImages\\Image8_SE1_06.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES1, "\\TestImages\\Image8_SE1_012.jpeg", w, h);

			ClearImage4x4(g_ImRES2, w, h, r);
			N2 = ClearImageOptimal(g_ImRES2, w, h, yb, ye, r);		
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES2, "\\TestImages\\Image8_SE1_022.jpeg", w, h);

			ClearImage4x4(g_ImRES3, w, h, r);
			N3 = ClearImageOptimal(g_ImRES3, w, h, yb, ye, r);		
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES3, "\\TestImages\\Image8_SE1_032.jpeg", w, h);

			ClearImage4x4(g_ImRES4, w, h, r);
			N4 = ClearImageOptimal(g_ImRES4, w, h, yb, ye, r);		
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES4, "\\TestImages\\Image8_SE1_042.jpeg", w, h);

			ClearImage4x4(g_ImRES5, w, h, r);
			N5 = ClearImageOptimal(g_ImRES5, w, h, yb, ye, r);		
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES5, "\\TestImages\\Image8_SE1_052.jpeg", w, h);

			ClearImage4x4(g_ImRES6, w, h, r);
			N6 = ClearImageOptimal(g_ImRES6, w, h, yb, ye, r);		
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES6, "\\TestImages\\Image8_SE1_062.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES8, "\\TestImages\\Image8_SE1_RES00.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES8, "\\TestImages\\Image8_SE1_RES01.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES9, "\\TestImages\\Image8_SE1_RES02.jpeg", w, h);
			...
			ClearImage4x4(g_ImRES9, w, h, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES9, "\\TestImages\\Image8_SE1_RES03.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES9, "\\TestImages\\Image8_SE1_RES04.jpeg", w, h);

			val = ClearImageLogical(g_ImRES9, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES9, "\\TestImages\\Image8_SE1_RES05!.jpeg", w, h);
			...
			ClearImage4x4(g_ImRES8, w, h, r);
			ClearImageOpt5(g_ImRES8, w, h, LH, LMAXY, jY_min, jY_max, j4_min, j4_max, j5_min, j5_max, mY, dY, mI, dI, mQ, dQ, mmY, ddY1, ddY2, mmI, ddI, mmQ, ddQ, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES8, "\\TestImages\\Image8_SE1_RES06.jpeg", w, h);		

			val = ClearImageLogical(g_ImRES8, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES8, "\\TestImages\\Image8_SE1_RES07!.jpeg", w, h);
			...
			ClearImage4x4(g_ImRES9, w, h, r);
			ClearImageOpt5(g_ImRES9, w, h, LH, LMAXY, jY_min, jY_max, j4_min, j4_max, j5_min, j5_max, mY, dY, mI, dI, mQ, dQ, mmY, ddY1, ddY2, mmI, ddI, mmQ, ddQ, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES9, "\\TestImages\\Image8_SE1_RES08.jpeg", w, h);		

			val = ClearImageLogical(g_ImRES9, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES9, "\\TestImages\\Image8_SE1_RES09!.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES9, "\\TestImages\\Image8_SE1_RES10.jpeg", w, h);
			ClearImageOpt5(g_ImRES9, w, h, LH, LMAXY, jY_min, jY_max, j4_min, j4_max, j5_min, j5_max, mY, dY, mI, dI, mQ, dQ, mmY, ddY1, ddY2, mmI, ddI, mmQ, ddQ, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES9, "\\TestImages\\Image8_SE1_RES11.jpeg", w, h);

			val = ClearImageLogical(g_ImRES9, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES9, "\\TestImages\\Image8_SE1_RES12!.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES4, "\\TestImages\\Image8_SE1_RES13.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES9, "\\TestImages\\Image8_SE1_RES14.jpeg", w, h);
		...
		{			
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES1, "\\TestImages\\Image8_SE2_01.jpeg", w, h);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES2, "\\TestImages\\Image8_SE2_02.jpeg", w, h);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES3, "\\TestImages\\Image8_SE2_03.jpeg", w, h);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES4, "\\TestImages\\Image8_SE2_04.jpeg", w, h);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES5, "\\TestImages\\Image8_SE2_05.jpeg", w, h);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES6, "\\TestImages\\Image8_SE2_06.jpeg", w, h);
			...
			N1 = ClearImageOptimal(g_ImRES1, w, h, yb, ye, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES1, "\\TestImages\\Image8_SE2_012.jpeg", w, h);

			//ClearImage4x4(g_ImRES2, w, h, r);
			N2 = ClearImageOptimal(g_ImRES2, w, h, yb, ye, r);		
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES2, "\\TestImages\\Image8_SE2_022.jpeg", w, h);

			//ClearImage4x4(g_ImRES3, w, h, r);
			N3 = ClearImageOptimal(g_ImRES3, w, h, yb, ye, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES3, "\\TestImages\\Image8_SE2_032.jpeg", w, h);

			//ClearImage4x4(g_ImRES4, w, h, r);
			N4 = ClearImageOptimal(g_ImRES4, w, h, yb, ye, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES4, "\\TestImages\\Image8_SE2_042.jpeg", w, h);

			//ClearImage4x4(g_ImRES4, w, h, r);
			N5 = ClearImageOptimal(g_ImRES5, w, h, yb, ye, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES5, "\\TestImages\\Image8_SE2_052.jpeg", w, h);
			
			ClearImage4x4(g_ImRES4, w, h, r);
			N6 = ClearImageOptimal(g_ImRES6, w, h, yb, ye, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES6, "\\TestImages\\Image8_SE2_062.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES8, "\\TestImages\\Image8_SE2_RES00.jpeg", w, h);

			LH = (LLE[k] - LLB[k])*4;
			val = ClearImageOpt2(g_ImRES8, w, h, r, LH, LMAXY, jY_min, jY_max, j4_min, j4_max, j5_min, j5_max, mY, dY, mI, dI, mQ, dQ, mmY, ddY1, ddY2, mmI, ddI, mmQ, ddQ);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES8, "\\TestImages\\Image8_SE2_RES01.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES6, "\\TestImages\\Image8_SE2_RES02.jpeg", w, h);			
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImFF, "\\TestImages\\Image8_SE2_RES03.jpeg", w, h);			
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImFF, "\\TestImages\\Image8_SE2_RES04.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES7, "\\TestImages\\Image8_SE2_RES05.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImFF, "\\TestImages\\Image8_SE2_RES06.jpeg", w, h);

			ClearImageOpt5(g_ImFF, w, h, LH, LMAXY, jY_min, jY_max, j4_min, j4_max, j5_min, j5_max, mY, dY, mI, dI, mQ, dQ, mmY, ddY1, ddY2, mmI, ddI, mmQ, ddQ, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImFF, "\\TestImages\\Image8_SE2_RES07.jpeg", w, h);
			
			val = ClearImageLogical(g_ImFF, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImFF, "\\TestImages\\Image8_SE2_RES08!.jpeg", w, h);
			...
			val = ClearImageLogical(g_ImRES8, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES8, "\\TestImages\\Image8_SE2_RES09!.jpeg", w, h);

			val = ClearImageLogical(g_ImRES7, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES7, "\\TestImages\\Image8_SE2_RES10!.jpeg", w, h);

			val = ClearImageLogical(g_ImRES6, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES6, "\\TestImages\\Image8_SE2_RES11!.jpeg", w, h);
			...
			val = ClearImageLogical(g_ImFF, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImFF, "\\TestImages\\Image8_SE2_RES12!.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImFF, "\\TestImages\\Image8_SE2_RES13.jpeg", w, h);
			...
			val = ClearImageLogical(g_ImFF, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImFF, "\\TestImages\\Image8_SE2_RES09!.jpeg", w, h);
			...
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES1, "\\TestImages\\Image8_SE2_RES10.jpeg", w, h);

			ClearImageLogical(g_ImRES1, w, h, LH, LMAXY, xb, xe, r);
			if (g_show_results == 1) g_pMF->SaveRGBImage(g_ImRES1, "\\TestImages\\Image8_SE2_RES11!.jpeg", w, h);
		...
		g_pMF->m_pImageBox->ViewRGBImage(g_ImFF, w, h);
		...
		Str = CString("\\TXTImages\\") + SaveName;
		
		sprintf(str, "%.2d", (int)SavedFiles.size() + 1);
		Str += CString("_") + CString(str);
		...
		g_pMF->SaveImage(g_ImRES1, Str, W*4, h);
...
int AnalizeAndClearImage(int *Im, int *ImGR, int w, int h, int j1_min, int j1_max, int r, int g, int yb, int ye, int xb, int xe, int &cnt1, int &cnt2)
{
	...
	if (g_debug == 1) g_pMF->SaveRGBImage(Im, "\\TestImages\\Image8_RG.jpeg", w, h);
	...
	if (g_debug == 1) g_pMF->SaveRGBImage(Im, "\\TestImages\\Image8_RGF.jpeg", w, h);
